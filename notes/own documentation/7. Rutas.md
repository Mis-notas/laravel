## Routes
Te permiten entrar en laravel y llamar a un recurso de tu interés.
...
Cuando directamente se llama a clase desde una ruta y no se especifique un método, se llamara al método invoke();
